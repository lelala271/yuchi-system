...
## 14. 如果准备写 GitHub 项目页，建议怎么拆内容

CSDN 适合写“一篇完整文章”，GitHub 更适合拆成结构化文档。

推荐这样拆：

| 文档 | 内容 |
|---|---|
| `README.md` | 项目简介、核心特性、快速启动 |
| `docs/architecture.md` | 架构说明、模块关系、数据流 |
| `docs/security.md` | 安全设计、认证、主题权限、上线建议 |
| `docs/deployment.md` | 部署步骤、环境变量、反代配置 |
| `docs/troubleshooting.md` | 常见问题排查表 |
| `docs/api.md` | REST API、WebSocket 事件、MQTT 主题说明 |
...
发 CSDN 或 GitHub 之前，建议按下面这份清单再过一遍：
...
如果这 7 条都满足，这篇文章就不只是“项目介绍”，而是一篇真正有工程价值的开发文章。
